        ...
        <div className="container">
            <div className="row mb-5">
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    <h2>Contact us</h2>
                    <p>We're here just a message away👇</p>
                </div>
            </div>
                    ...
                    <div className="d-flex flex-column justify-content-center align-items-start h-100">
                        <div className="d-flex align-items-center p-3">
                            ...
                            <div className="px-2">
                                ...
                                <p className="mb-0">+91-8805570815</p>
                            </div>
                        </div>
                        <div className="d-flex align-items-center p-3">
                            ...
                            <div className="px-2">
                                ...
                                <p className="mb-0">opulentcabs.help@gmail.com</p>
                            </div>
                        </div>
                        <div className="d-flex align-items-center p-3">
                            ...
                            <div className="px-2">
                                ...
                                <p className="mb-0">Phase 2 of Rajiv Gandhi Infotech Park, Hinjewadi, Pune - 411057, MH-INDIA</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-5 col-xl-4">
                    <div>
                        <form className="p-3 p-xl-4" method="post">
                            ...
                            <div className="mb-3">
                                <textarea className="form-control" id="message-1" name="message" rows="6" placeholder="Message" />
                            </div>
